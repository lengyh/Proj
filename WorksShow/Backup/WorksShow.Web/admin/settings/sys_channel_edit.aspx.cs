...
{
    public partial class sys_channel_edit : WorksShow.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == ActionEnum.Edit.ToString())
            {
                ...
                if (!new WorksShow.BLL.sys_channel().Exists(this.id))
                {
        ...
        {
            WorksShow.BLL.sys_channel bll = new WorksShow.BLL.sys_channel();
            WorksShow.Model.sys_channel model = bll.GetModel(_id);
            model.name = txtName.Text.Trim();
            model.title = txtTitle.Text.Trim();
            model.model_id = int.Parse(ddlModelId.SelectedValue);
            model.sort_id = int.Parse(txtSortId.Text.Trim());
