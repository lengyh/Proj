<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="WorksShow.Web.admin.article.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 内容管理 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#new WorksShow.BLL.category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
