...
{
    public partial class attribute_edit : WorksShow.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == ActionEnum.Edit.ToString())
            {
                ...
                if (!new WorksShow.BLL.photo_attribute().Exists(this.id))
                {
        ...
        {
            WorksShow.BLL.photo_attribute bll = new BLL.photo_attribute();
            WorksShow.Model.photo_attribute model = bll.GetModel(_id);
        ...
        {
            bool result = true;
            WorksShow.Model.photo_attribute model = new Model.photo_attribute();
            WorksShow.BLL.photo_attribute bll = new BLL.photo_attribute();
