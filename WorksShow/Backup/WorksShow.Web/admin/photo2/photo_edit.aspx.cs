...
namespace WorksShow.Web.admin.photo2
{
    public partial class photo_edit : WorksShow.Web.UI.ManagePage
    {
        ...
        private bool DoAdd()
        {
            ...
            model.market_price = 0;//decimal.Parse(txtMarketPrice.Text.Trim());
            model.sell_price = 0; //decimal.Parse(txtSellPrice.Text.Trim());
