...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.templateskin.ToString());
	templateBuilder.Append("/img/20.jpg\" /></div>\r\n                    <div class=\"lb_cont\">\r\n                        <ul>\r\n                            ");
	...
	templateBuilder.Append("\r\n                            <li><a href=\"");
	templateBuilder.Append(linkurl("successfulcase_list",cdr["id"].ToString().Trim(),1));

	templateBuilder.Append("\">" + cdr["title"].ToString().Trim() + "</a></li>\r\n                            ");
	}	//end loop


	templateBuilder.Append("\r\n                        </ul>\r\n                    </div>\r\n                </div>\r\n                <div class=\"zw\">\r\n                    <div class=\"zw_title\">\r\n                        成功案例<span>/Case</span></div>\r\n                    <div class=\"zw_cont\">\r\n                        <div class=\"zw_bt\">\r\n                            <h3>\r\n                                ");
	templateBuilder.Append(model.title.ToString());
	...
	string strlast = "";
	                    ...
	                    if (tempid > 0)
	                    {
	                        strFirst="上一篇：<a href='"+linkurl("successfulcase_show",tempid)+"'>"+(temptitle.Length>10?temptitle.Substring(0,10)+"...":temptitle)+"</a>";
	                    }else
	                    {
	                    ...
	                    if (tempid2 > 0)
	                    {
	                        strlast="下一篇：<a href='"+linkurl("successfulcase_show",tempid2)+"'>"+(temptitle2.Length>10?temptitle2.Substring(0,10)+"...":temptitle2)+"</a>";
	                    }else
	                    {
