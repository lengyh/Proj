...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" />\r\n    ");
	string category_title = get_category_title(category_id,"成功案例");
	...
	templateBuilder.Append("\r\n                        <!--取得一个DataTable-->\r\n                        ");
	string pagelist = get_page_link(9, page, totalcount, "successfulcase_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                        <div class=\"tt\">\r\n                            <a href=\"");
	templateBuilder.Append(linkurl("successfulcase_show",dr["id"].ToString().Trim()));
