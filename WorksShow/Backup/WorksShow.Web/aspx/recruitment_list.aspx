...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" />\r\n    ");
	string category_title = get_category_title(category_id,"人才招聘");
	...
	templateBuilder.Append("\r\n                            <!--取得一个DataTable-->\r\n                            ");
	string pagelist = get_page_link(7, page, totalcount, "recruitment_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                            <li><a href=\"");
	templateBuilder.Append(linkurl("recruitment_show",dr["id"].ToString().Trim()));
