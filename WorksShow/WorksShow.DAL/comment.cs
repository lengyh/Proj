...
namespace WorksShow.DAL
{
    ...
    public partial class comment
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WorksShow.Model.comment model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WorksShow.Model.comment model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WorksShow.Model.comment GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            WorksShow.Model.comment model = new WorksShow.Model.comment();
