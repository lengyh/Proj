...
;(function($) {
	$.fn.Xslider = function(options) {
		...
		function _show_text(i) {
			...
			$('.covertext a').text($contents.eq(i).attr('title'))
							.attr('href',$contents.eq(i).attr('href'))
							.attr('title',$contents.eq(i).attr('title'));
		}
		function _hide_text() { $('.overlay').hide();$('.covertext').hide()}	
	}
})(jQuery);