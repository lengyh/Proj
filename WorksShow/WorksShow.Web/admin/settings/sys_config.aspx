<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="WorksShow.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div id="contentTab">
    ...
    <div class="tab_con">
        <table class="form_table">
            ...
            <tr>
                <th>网站安装目录：</th>
                <td><asp:TextBox ID="webpath" runat="server" CssClass="txtInput normal required" maxlength="100">/</asp:TextBox><label>*根目录下，输入“/”；如：http://abc.com/web，输入“web/”</label></td>
            </tr>
            <tr>
                <th>网站管理目录：</th>
                <td><asp:TextBox ID="webmanagepath" runat="server" CssClass="txtInput normal required" minlength="2" maxlength="100">admin</asp:TextBox><label>*默认是admin，如已经更改，请输入目录名</label></td>
            </tr>
            <tr>
                <th>URL重写开关：</th>
                <td>
            ...
            <tr>
                <th>静态URL后缀：</th>
                <td><asp:TextBox ID="staticextension" runat="server" CssClass="txtInput small required" minlength="2" maxlength="100"></asp:TextBox><label>*扩展名，不包括“.”，如：aspx、html</label></td>
            </tr>
            <tr>
                <th>开启会员功能：</th>
                <td>
            ...
            <tr>
                <th>关闭原因描述：</th>
                <td><asp:TextBox ID="webclosereason" runat="server" maxlength="500" TextMode="MultiLine" CssClass="small"></asp:TextBox><label>支持HTML格式</label></td>
            </tr>
            <tr>
                <th>网站统计代码：</th>
                <td><asp:TextBox ID="webcountcode" runat="server" maxlength="500" TextMode="MultiLine" CssClass="small"></asp:TextBox><label>支持HTML格式</label></td>
            </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="tab_con">
        <table class="form_table">
            ...
            <tr>
                <th>STMP服务器：</th>
                <td><asp:TextBox ID="emailstmp" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*发送邮件的SMTP服务器地址</label></td>
            </tr>
            <tr>
                <th>SMTP端口：</th>
                <td><asp:TextBox ID="emailport" runat="server" CssClass="txtInput small required digits" maxlength="10">25</asp:TextBox><label>*SMTP服务器的端口</label></td>
            </tr>
            <tr>
                <th>发件人地址：</th>
                <td><asp:TextBox ID="emailfrom" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*</label></td>
            </tr>
            <tr>
                <th>邮箱账号：</th>
                <td><asp:TextBox ID="emailusername" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*</label></td>
            </tr>
            <tr>
                <th>邮箱密码：</th>
                <td><asp:TextBox ID="emailpassword" runat="server" CssClass="txtInput normal required" maxlength="100" TextMode="Password"></asp:TextBox><label>*</label></td>
            </tr>
            <tr>
                <th>发件人昵称：</th>
                <td><asp:TextBox ID="emailnickname" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*显示发件人的昵称</label></td>
            </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="tab_con">
        <table class="form_table">
            ...
            <tr>
                <th>附件上传目录：</th>
                <td><asp:TextBox ID="attachpath" runat="server" CssClass="txtInput normal required" minlength="2" maxlength="100">upload</asp:TextBox><label>*上传图片或附件的目录，自动创建在网站根目录下</label></td>
            </tr>
            <tr>
                <th>附件上传类型：</th>
                <td><asp:TextBox ID="attachextension" runat="server" CssClass="txtInput normal required" maxlength="250"></asp:TextBox><label>*以英文的逗号分隔开，如：“jpg,gif,rar”</label></td>
            </tr>
            <tr>
                <th>附件保存方式：</th>
                <td>
            ...
            <tr>
                <th>文件上传大小：</th>
                <td><asp:TextBox ID="attachfilesize" runat="server" CssClass="txtInput small required number" maxlength="10"></asp:TextBox>KB<label>*超过设置的文件大小不予上传，0不限制</label></td>
            </tr>
            <tr>
                <th>图片上传大小：</th>
                <td><asp:TextBox ID="attachimgsize" runat="server" CssClass="txtInput small required number" maxlength="10"></asp:TextBox>KB<label>*超过设置的图片大小不予上传，0不限制</label></td>
            </tr>
            <tr>
                <th>图片最大尺寸：</th>
                <td>
            ...
            <tr>
                <th>图片生成质量：</th>
                <td><asp:TextBox ID="watermarkimgquality" runat="server" CssClass="txtInput small required digits" maxlength="3">80</asp:TextBox><label>*只适用于加水印的jpeg格式图片.取值范围 0-100, 0质量最低, 100质量最高, 默认80</label></td>
            </tr>
            <tr>
                <th>图片水印文件：</th>
                <td><asp:TextBox ID="watermarkpic" runat="server" CssClass="txtInput normal required" maxlength="100">watermark.png</asp:TextBox><label>*需存放在站点目录下，如图片不存在将使用文字水印</label></td>
            </tr>
            <tr>
                <th>水印透明度：</th>
                <td><asp:TextBox ID="watermarktransparency" runat="server" CssClass="txtInput small required digits" maxlength="2" max="10">5</asp:TextBox><label>*取值范围1--10 (10为不透明)</label></td>
            </tr>
            <tr>
                <th>水印文字：</th>
                <td><asp:TextBox ID="watermarktext" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*文字水印的内容</label></td>
            </tr>
            <tr>
                <th>文字字体：</th>
                <td>
