<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WorksShow.Web.admin.index" %>
  ...
  <div position="top" class="header">
            <div class="header_box">
                <div class="header_right">
                    <span><b><%=admin_info.user_name %>（<%=new WorksShow.BLL.manager_role().GetTitle(admin_info.role_id) %>）</b>您好，欢迎光临</span>
                ...
                <a class="logo"></a>
                <asp:Label ID="logoName" runat="server" Text="" class="logoName"></asp:Label>
            </div>
