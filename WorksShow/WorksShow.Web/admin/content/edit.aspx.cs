...
namespace WorksShow.Web.admin.content
{
    public partial class edit : WorksShow.Web.UI.ManagePage
    {
        ...
        {
            bool result = true;
            WorksShow.Model.contents model = new Model.contents();
            WorksShow.BLL.contents bll = new BLL.contents();
        ...
        private bool DoEdit(int _id)
        {
            bool result = true;
            WorksShow.BLL.contents bll = new BLL.contents();
            WorksShow.Model.contents model = bll.GetModel(_id);
