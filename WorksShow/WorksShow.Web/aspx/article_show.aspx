...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string strlast = "";
	                    ...
	                    if (tempid > 0)
	                    {
	                        strFirst="上一篇：<a href='"+linkurl("article_show",tempid)+"'>"+(temptitle.Length>10?temptitle.Substring(0,10)+"...":temptitle)+"</a>";
	                    }else
	                    {
	                    ...
	                    if (tempid2 > 0)
	                    {
	                        strlast="下一篇：<a href='"+linkurl("article_show",tempid2)+"'>"+(temptitle2.Length>10?temptitle2.Substring(0,10)+"...":temptitle2)+"</a>";
	                    }else
	                    {
