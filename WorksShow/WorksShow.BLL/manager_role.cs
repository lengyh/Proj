...
namespace WorksShow.BLL
{
    ...
    {
        private readonly WorksShow.DAL.manager_role dal = new WorksShow.DAL.manager_role();
        public manager_role()
        { }
        #region  Method
        /// <summary>
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WorksShow.Model.manager_role model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WorksShow.Model.manager_role model)
        {
